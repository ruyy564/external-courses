...
const loadArrayDataInLocalStorage = (data) => {
...
const downloadDataFromLocalStorage = (key) => JSON.parse(localStorage.getItem(key));
...
const setStartTasksBeforeWork = (key) => {
...
const replaceInputWithTask = (input) => {
...
const replaceDropdownWithTask = (event) => {
